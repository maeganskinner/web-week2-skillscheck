...
// Create a function called 'oddChecker' that takes in one parameter, num. Check to see if the number is even or odd. 
// If it is odd, return 'the number is odd' or return 'the number is even' if it is even.
...
// and love which will be a string of something you love. Have the function take the two parameters and retrun a 
// string that says "NAMEPARAM loves LOVEPARAM" with the appropriate parameters in the string. e.g. "Bryan loves skateboarding"

function iLove(name, love){
	name="Bryan";
	love="Skateboarding";
	return iLove.name + iLove + iLove.love
...
// Create a new array called 'middleNums' from the numbers array that will capture only the middle numbers (2, 3, 4).
 ...
 var middleNums = numbers.splice(2,3,4)


//////////////////PROBLEM 11////////////////////

// Create an object called 'me' that has these keys with the correct values: firstName, state, age, greeter. firstName 
// will be your name as a string. state will be your current state or providence as a string. age will be your age as a number. 
...
// Create a function called 'bigOrSmall' that takes in one parameter, arr. Create a new array inside 
// of bigOrSmall called 'answers'. Loop over the passed in arr param. If the number is GREATER than 100, push 'big' 
// as a string to the answers array. If the number is LESS than or EQUAL to 100, push 'small' as a string to the answers array. 
